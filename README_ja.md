...
> erbfmtは現在プレリリース開発中です。Version `0.1.1`をGitHub Releasesで
> 公開しています。初期releaseはpackage indexやextension marketplaceへ登録しません。

## インストール

[v0.1.1 release](https://github.com/hinamimi/erbfmt/releases/tag/v0.1.1)から
...
`contenteditable` を持つelementのsubtreeも保持します。
...
- `pre`、`textarea`、`script`、`style`、`svg`、`math`、`contenteditable`
  subtreeなどのpreformatted / format-sensitive contentは安全側で保持します。
